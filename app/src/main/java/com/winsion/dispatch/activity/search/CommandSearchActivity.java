...
public class CommandSearchActivity extends BaseActivity {
    ...
    protected void obtainIntent() {
        ...
        datas = (List<ContractBean>)intent.getSerializableExtra("contracts");
        if(datas!=null){
    ...
    protected void initData() {
        ...
        adapter = new CommonAdapter<ContractBean>(this, R.layout.item_cmd, selectDatas) {
            @Override
            public void convert(ViewHolder holder, ContractBean s) {
                ...
                Glide.with(CommandSearchActivity.this).load(s.getHeadIcon()).placeholder(R.mipmap.ic_launcher).into((ImageView) holder.getConvertView().findViewById(R.id.cmd_image));
            }
        };
        ...
        mList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                T.show(CommandSearchActivity.this, content, 1);
            }
        });
    }
}
